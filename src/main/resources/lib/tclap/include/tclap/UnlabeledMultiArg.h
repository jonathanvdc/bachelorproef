...
public:
	 ...
	 */
	UnlabeledMultiArg(
	    const std::string& name, const std::string& desc, bool req, Constraint<T>* constraint,
	    bool ignoreable = false, Visitor* v = NULL);
...
UnlabeledMultiArg<T>::UnlabeledMultiArg(
    const std::string& name, const std::string& desc, bool req, const std::string& typeDesc, bool ignoreable,
    Visitor* v)
...
template <class T>
UnlabeledMultiArg<T>::UnlabeledMultiArg(
    const std::string& name, const std::string& desc, bool req, const std::string& typeDesc, CmdLineInterface& parser,
...
template <class T>
UnlabeledMultiArg<T>::UnlabeledMultiArg(
    const std::string& name, const std::string& desc, bool req, Constraint<T>* constraint, CmdLineInterface& parser,
    bool ignoreable, Visitor* v)
    : MultiArg<T>("", name, desc, req, constraint, v)
{
	_ignoreable = ignoreable;
